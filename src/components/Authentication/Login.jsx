...
const Login = () => {
  ...
  return (
    <div className="relative bg-linear-to-bl from-blue-100 via-transparent">
      <div className="max-w-[1440px] px-2 py-10  mx-auto">
        {/* Grid */}
        <div className="grid items-center md:grid-cols-2 gap-8 lg:gap-12">
          <div>
            <p className="inline-block text-sm font-medium bg-clip-text bg-linear-to-l from-blue-600 to-violet-500 text-transparent">
              Panda News: A vision for {format(new Date(), 'yyyy')}
            </p>
          ...
          {authLoader ? (
            ...
            <div className="p-4 sm:p-7 flex flex-col bg-white rounded-2xl shadow-lg space-y-5">
              <p>You have already Login . Please logout then try to login .</p>
                ...
                <div className="p-4 sm:p-7 flex flex-col bg-white rounded-2xl shadow-lg">
                  ...
                  <div className="mt-5">
                    ...
                    <button
                      ...
                      className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-black text-white mt-2"
                    >
                      <svg
                      ...
                      <div className="grid  gap-4">
                        <div className="relative">
                          <input
                            type="email"
                            name="email"
                            className="peer p-3 sm:p-4 block w-full border-gray-200 rounded-lg sm:text-sm placeholder:text-transparent disabled:opacity-50 disabled:pointer-events-none
                      focus:pt-6
                      focus:pb-2
                      not-placeholder-shown:pt-6
                      not-placeholder-shown:pb-2
                      autofill:pt-6
                      autofill:pb-2 outline-2 outline-gray-300 focus:outline-blue-600"
                            placeholder="Email"
                            required
                          />
                          <label
